  ...
  <p>{todo.completed ? <IoCheckmarkDoneSharp/>: <ImCross/>}</p>
      ...
      <div className='flex items-center gap-7'>
        ...
        
        {
          ...
          <button onClick={()=>setupdatebtn(true)} className='border border-blue-500 bg-blue-500 text-white py-2 px-4 rounded-r-xl hover:bg-blue-600 transition duration-300 ml-2'><MdEdit/></button>
        }
        </div>
